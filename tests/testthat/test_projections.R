...
test_that("basic projections (that don't need extra values) work", {
  ...
  #expect_is(map_phyloseq(batfecal, projection="bonne") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="azequalarea") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="azequidistant") , "ggplot")
  #expect_is(map_phyloseq(batfecal, projection="cylindrical") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="gilbert") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="globular") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="gnomonic") , "ggplot")  
  expect_is(map_phyloseq(batfecal, projection="guyou") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="hex") , "ggplot")
  expect_is(map_phyloseq(batfecal, projection="lagrange") , "ggplot")
  ...
  expect_is(map_phyloseq(batfecal, projection="square") , "ggplot")
...
test_that("Projections with Lat0 work", {
  ...
  #expect_is(map_phyloseq(batfecal, projection="gall", lat0=15) , "ggplot")
