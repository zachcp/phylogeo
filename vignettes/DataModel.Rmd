...
Phyloseq provides toolf for dealing with the first three items on this list. By adding lociton information and phylogenetic information you can take advantage fo the plotting tools in the phylogeo package.

Note: If these data-types don't make sense to you, it may be worthwhile to look at the [phyloseq tutorials](http://joey711.github.io/phyloseq/tutorials-index) to get your bearings. For a grasp of what OTUs are and how they are used in metagenome analysis you could do worse than to start with Robert Edgars' page on [OTUs](http://www.drive5.com/usearch/manual/otu_definition.html). Edgar is the author of a number  of highly used bioinformatic programs that comarse DNA sequences including Muscle and USeqrch (see [here](http://drive5.com/software.html)).
