...
phylogeo has three datasets. 
  ...
  - `mountainsoil` is the biom data and associated sample information from the microbio.me/qiime [experiment 1702](microbio.me/qiime/1702)
...
map_network(epoxomicin_KS, color="Region", jitter=TRUE, lines=TRUE, line_weight = 2)
```
